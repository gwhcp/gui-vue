<template>
    ...
    <div class="row mb-3">
        <div v-if="cellSelected"
             class="col-auto">
            <router-link :to="{ name: 'admin:customer:billing:invoice:profile', params: { id: profileId, invoice_id: cellParams['id'] } }">
...
export default defineComponent({
    ...
    setup() {
        const { formArr, getSearchInvoice } = useAdminCustomerBilling();

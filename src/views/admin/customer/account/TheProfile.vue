<template>
    <nav class="nav nav-pills nav-justified mb-3">
        ...
        <router-link :to="{ name: 'admin:customer:account:accesslog', params: { id: accountId } }"
...
import { useAdminCustomerAccount, useAuth } from "@/composables";
...
export default defineComponent({
    ...
    setup() {
        const { formErrors, formObj, formSuccess, getProfile, updateProfile } = useAdminCustomerAccount();

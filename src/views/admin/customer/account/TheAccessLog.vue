<template>
    <nav class="nav nav-pills nav-justified mb-3">
        <router-link :to="{ name: 'admin:customer:account:profile', params: { id: accountId } }"
...
import { useAdminCustomerAccount, useSearchGrid } from "@/composables";
...
export default defineComponent({
    ...
    setup() {
        const { formArr, getAccessLog } = useAdminCustomerAccount();
